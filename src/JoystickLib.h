...
#define JL_CENTER_TOLERANCE 500
...
/**
 * @brief Possible joystick states.
 */
enum JoystickStates {
	CENTER,
	UP,
...
public:
	/**
	 * @brief Initializes a new instance of the Joystick class. This is the default
	...
	/**
	 * @brief Initializes a new instance of the Joystick class with the analog input
	...
	/**
	 * @brief Sets the analog input pins to use for the X and Y-axis.
	 * @param x The analog input pin to read for the X-axis position.
	 * @param y The analog input pin to read for the Y-axis position.
	 */
	...
	/**
	 * @brief Configures the threshold values for the joystick.
	...
	/**
	 * @brief Calibrates the joystick based on "resting position" values.
	 */
	void calibrate();

	/**
	 * @brief Reads the joystick positional values and processes event callbacks. This
	 * should be called within the main loop() method of your sketch.
	 */
	void loop();

	/**
	 * @brief Checks to see if the joystick is in the center position.
	 * @return true if centered; Otherwise, false.
	 */
	bool isCenter();

	/**
	 * @brief Checks to see if the joystick is in the up position.
	 * @return true if up; Otherwise, false.
	 */
	bool isUp();

	/**
	 * @brief Checks to see if the joystick is in the right and up position.
	 * @return true if right-up; Otherwise, false.
	 */
	bool isRightUp();

	/**
	 * @brief Checks to see if the joystick is in the right position.
	 * @return true if right; Otherwise, false.
	 */
	bool isRight();

	/**
	 * @brief Checks to see if the joystick is in the right and down position.
	 * @return true if right-down; Otherwise, false.
	 */
	bool isRightDown();

	/**
	 * @brief Checks to see if the joystick is in the down position.
	 * @return true if down; Otherwise, false.
	 */
	bool isDown();

	/**
	 * @brief Checks to see if the joystick is in the left and down position.
	 * @return true if down; Otherwise, false.
	 */
	bool isLeftDown();

	/**
	 * @brief Checks to see if the joystick is in the left position.
	 * @return true if left; Otherwise, false.
	 */
	bool isLeft();

	/**
	 * @brief Checks to see if the joystick is in the left and up position.
	 * @return true if left-up; Otherwise, false.
	 */
	bool isLeftUp();

	/**
	 * @brief Checks to see if the joystick is not centered.
	 * @return true if not centered; Otherwise, false.
	 */
	bool isNotCenter();

	/**
	 * @brief Gets the X-axis value.
	 * @return The X-axis value.
	 */
	int getX();

	/**
	 * @brief Gets the Y-axis value.
	 * @return The Y-axis value.
	 */
	int getY();

	/**
	 * @brief Sets the method to call when the joystick is centered.
	 * @param centerCallback The method to call when centered.
	 */
	void onCenter(void (*centerCallback)(void));

	/**
	 * @brief Sets the method to call when the joystick is in the up position.
	 * @param upCallback The method to call when up.
	 */
	void onUp(void (*upCallback)(void));

	/**
	 * @brief Sets the method to call when the joystick is in the right-up position.
	 * @param rightUpCallback The method to call when right-up.
	 */
	void onRightUp(void (*rightUpCallback)(void));

	/**
	 * @brief The method to call when the joystick is in the right position.
	 * @param rightCallback The method to call when right.
	 */
	void onRight(void (*rightCallback)(void));

	/**
	 * @brief Sets the method to call when the joystick is in the right-down position.
	 * @param rightDownCallback The method to call when right-down.
	 */
	void onRightDown(void (*rightDownCallback)(void));

	/**
	 * @brief Sets the method to call when the joystick is in the down position.
	 * @param downCallback The method to call when down.
	 */
	void onDown(void (*downCallback)(void));

	/**
	 * @brief Sets the method to call when the joystick is in the left-down position.
	 * @param leftDownCallback The method to call when left-down.
	 */
	void onLeftDown(void (*leftDownCallback)(void));

	/**
	 * @brief Sets the method to call when the joystick is in the left position.
	 * @param leftCallback The method to call when left.
	 */
	void onLeft(void (*leftCallback)(void));

	/**
	 * @brief Sets the method to call when the joystick is in the left-up position.
	 * @param leftUpCallback The method to call when left-up.
	 */
	void onLeftUp(void (*leftUpCallback)(void));

	/**
	 * @brief Sets the method to call when the joystick is not centered.
