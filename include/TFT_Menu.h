...
class TFT_MENU
{
    public:
        ...
        TFT_MENU(TFT_eSPI& tft, AnalogJoystick& joystick, int menuFont = 1, uint8_t textSize = 1);
...
TFT_MENU::TFT_MENU(TFT_eSPI& tfts, AnalogJoystick& joystick, int menuFont, uint8_t textSize) {
  this->tft = &tfts;
